...
export const mockManagerSummary: ManagerSummary = {
  ...
  team_wellbeing_score: 60.3,
  average_stress: 3.67,
  average_fatigue: 3.0,
  high_risk_count: 1,
  behavioral_strain_avg: 57.3,
  meeting_load_avg: 49.7,
  top_risk_drivers: [
    "Elevated team stress in delivery windows",
    "Behavioral strain is rising for 2 employees",
    "Meeting load remains high mid-week",
  ],
  employees: mockTeamEmployees,
  trend: [
    { date: "2026-04-09", team_score: 52 },
    { date: "2026-04-10", team_score: 55 },
    { date: "2026-04-11", team_score: 57 },
    { date: "2026-04-12", team_score: 59 },
    { date: "2026-04-13", team_score: 60.3 },
  ],
};
...
export const mockManagerRecommendations: ManagerRecommendation = {
  ...
  reasons: [
    "Stress remains above baseline for the team",
    "Behavioral strain has increased for two members",
    "High-risk concentration around one employee",
  ],
};
